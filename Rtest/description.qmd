...
$$
g_n^b=\sum_{l=1}^L \frac{d_{nl} - 2 q_l}{\sqrt{2} q_l (1-q_l)} \{A^b_{l} - K^b_l q_l\}
$$
...
$$
g_{nn'}^b=\sum_{l=1}^L \sum_{k=1}^{K^b_l} \frac{\frac{d_{nl}+d_{n'l}}{2} - 2 q_l}{\sqrt{q_l (1-q_l)}} \frac{X_{bk} - q_l}{\sqrt{q_l (1-q_l)}}
= \sum_{l=1}^L  \frac{\frac{d_{nl}+d_{n'l}}{2} - 2 q_l}{q_l (1-q_l)}  \{A^b_{l} - K^b_l q_l\}
$$
but now we can express it in terms of singlets:
$$
g_{nn'}^b=\sum_{l=1}^L  \frac{ \frac{d_{nl} - 2 q_l}{2} + \frac{d_{n'l} -  2 q_l}{2} }{q_l (1-q_l)}  \{A^b_{l} - K^b_l q_l\} = \sqrt{2} \frac{g_{n}^b+g_{n'}^b}{2}
$$

## DLDA for $M$-let

$$
g_{n_1,...,n_M}^b=\sum_{l=1}^L  \frac{ \sum_m^M \frac{d_{n_m,l} - 2 q_l}{M}}{\sqrt{2/M} q_l (1-q_l)}   \{A^b_{l} - K^b_l q_l\}
$$
